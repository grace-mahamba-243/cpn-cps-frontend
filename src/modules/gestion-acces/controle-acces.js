...
const PERMISSIONS = Object.freeze({
  ...
  CPS_ENFANT_CONSULTER: 'cps_enfant.consulter',
  CPS_ENFANT_GERER: 'cps_enfant.gerer',
...
const CATALOGUE_PERMISSIONS = Object.freeze([
  ...
  creerPermission(
    ...
    'Gerer les dossiers CPS Femme',
    'Permet d ouvrir, modifier et enregistrer les dossiers et visites CPS Femme.',
    'Soins',
  ),
  creerPermission(
    PERMISSIONS.CPS_ENFANT_CONSULTER,
    'Consulter les dossiers CPS Enfant',
    'Permet d acceder a la liste et au detail des dossiers de suivi postnatal enfant.',
    'Soins',
  ),
  creerPermission(
    PERMISSIONS.CPS_ENFANT_GERER,
    'Gerer les dossiers CPS Enfant',
    'Permet d ouvrir, modifier et enregistrer les dossiers et visites CPS Enfant.',
    'Soins',
  ),
  creerPermission(
...
const ROLES_PAR_DEFAUT = Object.freeze([
  ...
  },
  {
    code: 'MEDECIN',
    libelle: 'Medecin',
    description: 'Supervise les activites cliniques et accede a tous les modules medicaux.',
    estSysteme: true,
    permissions: [
      PERMISSIONS.TABLEAU_BORD_CONSULTER,
      PERMISSIONS.PATIENTS_CONSULTER,
  ...
  },
  {
    code: 'INFIRMIERE',
    libelle: 'Infirmiere',
    description: 'Intervient dans la prise en charge prenatale et les accouchements.',
    estSysteme: true,
    permissions: [
      PERMISSIONS.TABLEAU_BORD_CONSULTER,
      PERMISSIONS.PATIENTS_CONSULTER,
